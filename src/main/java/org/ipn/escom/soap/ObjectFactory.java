 ...
 * generated in the org.ipn.escom.soap package. 
...
public class ObjectFactory {
    ...
    private final static QName _SaludarResponse_QNAME = new QName("http://soap.escom.ipn.org/", "saludarResponse");
    private final static QName _Saludar_QNAME = new QName("http://soap.escom.ipn.org/", "saludar");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.ipn.escom.soap
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.escom.ipn.org/", name = "saludarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.escom.ipn.org/", name = "saludar")
